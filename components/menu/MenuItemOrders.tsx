...
import { LARGEBUTTON, MINIBUTTON } from "@/constants/size";
            ...
            {handleChange ?
                (
                    <Swipeable renderRightActions={renderDeleteButton}>
                        <View style={[menuItemOrderStyles.container, globalStyles.cardBackgroundColor, globalStyles.borderColor]}>
                            <View style={menuItemOrderStyles.overlay}>
                                ...
                                <View style={menuItemOrderStyles.detailContainer}>
                                    <Text style={[menuItemOrderStyles.nameText, globalStyles.textBold]} numberOfLines={1} ellipsizeMode="tail">
                                        {data.name}
                                    </Text>
                                    <Text style={[menuItemOrderStyles.priceText, globalStyles.textBold]}>
                                ...
                                <View style={menuItemOrderStyles.buttonContainer}>
                                    ...
                                    <Text style={[menuItemOrderStyles.quantityText, globalStyles.text]}>x{quantity}</Text>
